...
export const ADMIN_NAV_ITEMS = [
  ...
  { label: "Services", icon: SlidersHorizontal, path: "/services", page: "services" },
  { label: "Members", icon: Users, path: "/members", page: "members" },
  { label: "Reports", icon: FileText, path: null },
  { label: "Integrations", icon: Plug, path: null },
...
export const ADMIN_PAGE_META = {
  ...
  services: { title: "Services", subtitle: "Create service lines and assign them to counters.", icon: SlidersHorizontal },
